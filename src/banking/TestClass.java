...
public class TestClass {
	...
	public static void main(String[] args) {
		...
		testNoParams.accountSummary();
		System.out.println("Attempting to deposit $50");
		testNoParams.deposit(50.0);
		System.out.println("Attempting to withdraw $30");
		testNoParams.withdrawal(30.0);
		System.out.println("Attempting to withdraw $40");
		testNoParams.withdrawal(40.0);
		testNoParams.accountSummary();
		System.out.println("Interest Rate: " + testNoParams.getInterestRate());
